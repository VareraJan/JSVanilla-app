...
export class CardService {
	 ...
	 *
	 * @param {number} amount - The amount to be added or withdrawn
	 * from the user's balance.
	 * @param {'top-up' | 'withdrawal'} type - The type of the
	 * transaction, either "top-up" or "withdrawal".
	 * @param {function} onSuccess - The callback function to be
	 * executed when the balance update is successful.
	 * @returns {Promise} A Promise object that resolves to the
	 * response from API.
	 */
	 ...
	 * @returns {Promise} A promise that resolve with the vareraQuery response.
	 */
